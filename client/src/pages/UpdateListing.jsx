...
import { FaHome, FaMapMarkerAlt, FaBed, FaBath, FaDollarSign, FaTag, FaParking, FaCouch, FaCloudUploadAlt, FaTrash, FaEdit } from "react-icons/fa";
    ...
    <main className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800">Update Listing</h1>
          <p className="text-gray-500 mt-2">Modify your property details</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-4 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-70"
            >
              {loading ? (
                <span className="flex items-center justify-center gap-2">
                  <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
