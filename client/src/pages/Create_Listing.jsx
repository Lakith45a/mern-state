      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col gap-4">
            ...
            formData.imageUrls.map((url, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-red-600 font-bold border border-red-700 rounded px-2 py-1 hover:opacity-75  uppercase"
                >
                  Delete
                </button>
              </div>
          ...
          <button
            ...
            type="submit"
            className="bg-blue-700 hover:opacity-95 p-3 rounded-lg text-white font-bold uppercase mt-3 disabled:opacity-80"
          >
